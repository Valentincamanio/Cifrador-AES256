...
def cifrar_archivo(ruta_origen: str, ruta_destino: str, contrasenia: str):
    ...
    print(f"Archivo encriptado y guardado en '{ruta_destino}' !")
...
def descifrar_archivo(ruta_origen: str, ruta_destino: str, contrasenia: str):
    ...
    # preparamos el descifrador con misma forma CBC
    cifrador = Cipher(algorithms.AES(clave), modes.CBC(iv), backend=default_backend())
    ...
    print(f"Archivo desencriptado con éxito en '{ruta_destino}' !")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Error: La contraseña está mal o el archivo está corrupto.")
